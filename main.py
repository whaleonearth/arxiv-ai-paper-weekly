...
def generate_paper_summaries(papers: List[TrendingPaper], max_summaries: int = 10, env_config: dict = None) -> None:
...
def main() -> None:
    ...
    try:
        ...
        top_paper_count = min(10, len(papers))  # Summarize top 10 papers
